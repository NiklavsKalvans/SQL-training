...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = `delete from directors where director.id = ${directorId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = `delete from actors where actor.id = ${actorId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = `delete from keywords where keyword.id = ${keywordId}`;
      try {
        await db.delete(query);
      } catch (e) {}
